            ...
            <div class="modal-body">
                <form id="biodata_form">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="example@aqses.com" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nomor_telepon" placeholder="" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tanggal_lahir" placeholder="" required>
                    </div>
                    <div class="form-group">
                        <label for="tempat_lahir">Tempat Lahir</label>
                        <input type="text" class="form-control" id="tempat_lahir" placeholder="" required>
                    </div>
                    <div class="form-group">
