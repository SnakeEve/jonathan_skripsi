                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label>Soal</label>
                                    <textarea class="form-control" id="data_soal" rows="6"></textarea>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function () {
        datatable_main = $('#main_datatable').DataTable({
            ...
            responsive: true,
            ajax: {
                "url": "../api/admin/soal.php?apiname=list_by_kecerdasan&id_kecerdasan="+kecerdasan_id,
                "type": "GET",
                "headers": {
            ...
            columns: [
                ...
                {"data": "id_kecerdasan", "visible": false},
                {"data": "nama"}
            ],
            columnDefs: [
                {
        ...
        $('#main_datatable tbody').on('click', '.btnModalDataDelete', function () {
            if (confirm("Are you sure?")) {
                ...
                $.ajax({
                    url: '../api/admin/soal.php?apiname=delete',
                    type: 'POST',
        ...
        $('#formData').on('submit', function (e) {
            ...
            if(submit_type == 'update'){
                ...
                $.ajax({
                    url: '../api/admin/soal.php?apiname=update',
                    type: 'POST',
                    data: JSON.stringify(formDataObject),
                    contentType: "application/json",
                    dataType: "json",
                ...
                $.ajax({
                    url: '../api/admin/soal.php?apiname=insert',
                    type: 'POST',
                    data: JSON.stringify(formDataObject),
                    contentType: "application/json",
                    dataType: "json",
